...
const ottServices = [
  // 공개 방송통신사업자
  {
    category: '공개 방송통신사업자',
    name: 'Wave',
    logoUrl: 'https://image.wavve.com/logo/wavve-logo.png',
  },
  {
    category: '공개 방송통신사업자',
    name: 'Tving',
    logoUrl: 'https://i.namu.wiki/i/zOKJCJb_1LKmhWw9C-0bsHrOlgtILLdNkRE0z7o2iYg.svg',
  },
  {
    category: '공개 방송통신사업자',
    name: '시즌(Seezn)',
    logoUrl: 'https://seezn.com/web/img/common/logo_seezn.png',
  },
  {
    category: '공개 방송통신사업자',
    name: 'U+모바일 TV',
    logoUrl: 'https://www.uplus.co.kr/static/images/common/logo_uplus.png',
  },
  {
    category: '공개 방송통신사업자',
    name: '곰TV',
    logoUrl: 'https://www.gomtv.com/images/common/logo.png',
  },
  {
    category: '공개 방송통신사업자',
    name: '네이버 TV',
    logoUrl: 'https://ssl.pstatic.net/static/nid/login/img/bi_naver.png',
  },

  // 공개 인터넷서비스사업자
  {
    category: '공개 인터넷서비스사업자',
    name: 'V live',
    logoUrl: 'https://www.vlive.tv/favicon.ico',
  },
  {
    category: '공개 인터넷서비스사업자',
    name: '아프리카 TV',
    logoUrl: 'https://res.afreecatv.com/images/afmain/img_logo.png',
  },
  {
    category: '공개 인터넷서비스사업자',
    name: '왓챠 플레이',
    logoUrl: 'https://watcha.com/images/watcha_logo.png',
  },
  {
    category: '공개 인터넷서비스사업자',
    name: '카카오 TV',
    logoUrl: 'https://tv.kakao.com/favicon.ico',
  },
  {
    category: '공개 인터넷서비스사업자',
    name: '쿠팡 플레이',
    logoUrl: 'https://m.coupangplay.com/favicon.ico',
  },
  {
    category: '공개 인터넷서비스사업자',
    name: '판도라 TV',
    logoUrl: 'https://www.pandora.tv/favicon.ico',
  },

  // 해외 인터넷서비스사업자
  {
    category: '해외 인터넷서비스사업자',
    name: '넷플릭스',
  ...
  },
  {
    category: '해외 인터넷서비스사업자',
    name: '데일리 모션',
    logoUrl: 'https://www.dailymotion.com/favicon.ico',
  },
  {
    category: '해외 인터넷서비스사업자',
    name: '디즈니 플러스',
...
export function generateOTTSurvey(): Question {
  ...
  // 카테고리별로 그룹화
  const servicesByCategory = ottServices.reduce(
    (acc, service) => {
  ...
  const ottQuestion: Question = {
    ...
    order: 0,
    tableTitle:
      'A6-1. 이용하고 계시는 OTT 서비스가 무료인지, 아니면 월 정액제를 이용하거나 추가 요금을 지불하고 이용하고 계신 지 체크해 주세요. (복수응답)',
...
// 설문 응답 데이터 검증 함수
export function validateOTTSurveyResponse(tableRowsData: TableRow[]): {
  isValid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
